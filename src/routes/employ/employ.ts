...
employRoutr.post('/',isAuthenticated,hasPermission([RoleName.ADMIN]),hashPasswordMiddleware,createEmployValidations,employController.create.bind(employController))
